...
const RentalDeals = () => {
  ...
  const CarCard = ({
    ...
    <article className="rounded-lg border-2 border-yellow-400 border-solid overflow-hidden w-64 bg-white transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-xl cursor-pointer">
      <img
        src={image}
